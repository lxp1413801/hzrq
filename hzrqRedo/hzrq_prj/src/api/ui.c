...
void ui_disp_menu_id(void)
{
	...
	m_mem_cpy_len(lcdBuf,sysData.hzrqMeterId+8,8);
	m_lcd_disp_str(lcdBuf);
...
void ui_disp_menu(void)
{
	...
	if((nbRun && (globleTickerSec & 1UL)) || !nbRun){
		ui_disp_comm_rssi_segment(rssi);
