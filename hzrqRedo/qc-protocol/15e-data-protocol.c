...
const stDeviceInf_t sysDataDefault={
	...
	"0125200510000004",	//uint8_t		hzrqMeterId[32]
...
{
	uint32_t t32=0;
	t32=m_bcd_2_hex(sysRtcDataTime.hh);
	t32*=3600;
	t32=t32+(uint32_t)(m_bcd_2_hex(sysRtcDataTime.mm))*60;
	t32=t32+m_bcd_2_hex(sysRtcDataTime.ss);
	return t32;
}
